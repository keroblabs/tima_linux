...
#define FILENAME_IMAGE			"/Users/marciocherobim/Projects/GIT/disc_005.vhd"
...
static int _unit_write_block( uint64_t addr, uint8_t * buffer, uint32_t size )
{
    ...
    CONSOLE_PRINTK( "Write addr 0x%08x\r\n", addr );
...
static const msd_driver_t emul_disc_mount =
{
	flash_mass_name,
...
DECLARE_STORAGE_DEVICE_SECTION( emul_disc_mount );
