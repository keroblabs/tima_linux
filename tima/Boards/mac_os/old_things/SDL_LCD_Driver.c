...
#define SDL_WINDOWS_TITLE       "SDL Window"
...
void cocoa_update_view( char * title );
...
void sdl_update_window( void )
{
    ...
    //cocoa_update_view( SDL_WINDOWS_TITLE );
}
...
int create_window( void )
{
    ...
    //Create window
    window = SDL_CreateWindow( SDL_WINDOWS_TITLE, SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SDL_SCREEN_WIDTH, SDL_SCREEN_HEIGHT, 0 );
    if( window == NULL )
    {
